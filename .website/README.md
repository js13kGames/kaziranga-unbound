...
- **Jump / Stomp**: `[SPACE]`, `[W]`, `[UP]`, or `[Left Click]` *(Hold for higher jumps / stomp on enemies from above)*
- **Rainbow Dash / Horn Shield**: `[SHIFT]`, `[D]`, `[RIGHT]`, or `[Right Click]` *(Hold to charge forward at hypersonic speed and deflect bullets!)*
- **Pause / Resume**: `[ESC]` or `[P]`
- **Quick Restart**: `[R]`

### 📱 Mobile & Touch
- **Dedicated Arcade Touch Buttons**: On-screen **JUMP** and **DASH** arcade buttons.
- **Orientation Support**: Full responsive adaptation for both Landscape and Portrait modes.

---

## ⚔️ Gameplay Mechanics

- **Horn Deflection**: Activate your Rainbow Dash to raise your indestructible horn shield. Incoming sniper bullets will bounce off your horn and reflect straight back at the hunters!
- **Multi-Tiered Gauntlet**:
  - **Ground**: Swamps, bulldozers, jeeps, and pa